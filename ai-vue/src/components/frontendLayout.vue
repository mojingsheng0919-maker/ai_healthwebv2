...
const iconUrl = new URL('@/assets/images/机器人.png', import.meta.url).href// 图标路径

const isLoggedIn = ref(false)// 是否登录状态
...
onMounted(() => {
  // 检查是否有token
    isLoggedIn.value = localStorage.getItem('token') !== null// 检查是否有token
})
</script>
